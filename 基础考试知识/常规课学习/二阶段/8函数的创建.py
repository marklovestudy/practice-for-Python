...
def bb(name):             #name叫形参
    ...
    t.forward(100)
    t.write(str1)
def cc(car_name,g=0):                   #参数默认值
    print('%s跑了%s公里'%(car_name,g))
    if g>200:
        print('油不够用了，要加油了。')
    else:
        print('还有很多油。')
def dd(*args,**kwargs):     #列表和字典传值
    print(args)
    print(kwargs)
#aa()
#bb('林子博')               #实参
...
# print(v)
# t.mainloop()
#第二种可以接一个关系式，返回这个关系式的地址
v1 = lambda x,y,z:print((x+1,y+1,z+1))
v1(4,5,6)